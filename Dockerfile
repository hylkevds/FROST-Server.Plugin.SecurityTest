...
ENV plugins_modelLoader_securityPath='webapps/FROST-Server/WEB-INF/data/model'
ENV plugins_modelLoader_securityFiles='secDatastreams.json, secObservations.json, secProjects.json, secThings.json'
